...
{
    public class OrderStartesDomainEventHandler : INotificationHandler<OrderStartedDomainEvent>
    {
        private readonly IBuyerRepository buyerRepository;

        public OrderStartesDomainEventHandler(IBuyerRepository buyerRepository)
        {
