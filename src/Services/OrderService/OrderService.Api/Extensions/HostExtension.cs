...
namespace OrderService.Api.Extensions
{
    public static class HostExtension
    {
            ...
            where TContext : DbContext
        {
            using (var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    retry.Execute(() => InvokeSeeker(seeder, context, services));
        ...
        private static void InvokeSeeker<TContext>(Action<TContext, IServiceProvider> seeder, TContext context, IServiceProvider services)
            where TContext : DbContext
        {
