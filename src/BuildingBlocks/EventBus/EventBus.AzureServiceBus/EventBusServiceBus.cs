...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            {
                var subscriptionClient = CrateSubscriptionClientIfNotExists(eventName);
        ...
        public override void UnSubscribe<T, TH>()
        {
            ...
            try
            {
                ...
                var subscriptionClient = CrateSubscriptionClient(eventName);
        ...
        private ISubscriptionClient CrateSubscriptionClientIfNotExists(string eventName)
        {
            var subClient = CrateSubscriptionClient(eventName);
        ...
        private SubscriptionClient CrateSubscriptionClient(string eventName)
        {
